  ...
  if (res.data && !res.data.code) {
    if (res.data.data === null || res.data.data.length === 0) {
      ...
      res.data.data.forEach((obj, i) => {
        ...
        if (i < 3) {
          if (obj.linkTag === 0) {
            advert = `<div class="col-xs-12 col-sm-6 img1 img animated"><a href="${obj.linkUrl}" style="background-image: url(${obj.pircUrlWhole});" target="_blank"><img src="${obj.pircUrlWhole}"></a></div>`
          } else if (obj.linkTag === 1) {
            advert = `<div class="col-xs-12 col-sm-6 img1 img animated"><a href="/detail?shopId=${shopId}&productId=${obj.linkUrl}" style="background-image: url(${obj.pircUrlWhole});" target="_blank"><img src="${obj.pircUrlWhole}"></a></div>`
          } else if (obj.linkTag === -1) {
            advert = `<div class="col-xs-12 col-sm-6 img1 img animated"><a href="javascript:;" style="background-image: url(${obj.pircUrlWhole});" target="_blank"><img src="${obj.pircUrlWhole}"></a></div>`
          }
