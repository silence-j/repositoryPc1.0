...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__detail_detailApi__ = __webpack_require__(95);
...
$send.on('click', function (e) {
  ...
  params['shopId'] = __WEBPACK_IMPORTED_MODULE_1__serveice__["a" /* default */].getUrlParams('shopId');
  ...
  __WEBPACK_IMPORTED_MODULE_0__detail_detailApi__["a" /* default */].submitSupplier(params).then(function (res) {
    if (res.data && !res.data.code) {
      ...
      __WEBPACK_IMPORTED_MODULE_1__serveice__["a" /* default */].alert('Thanks for your feedback, we will have sales contact later');
    } else {
      __WEBPACK_IMPORTED_MODULE_1__serveice__["a" /* default */].alert(res.data.message, 'info');
    }
  });
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_js_home__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__home_common_header_js__ = __webpack_require__(365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_js_contacts_index_js__ = __webpack_require__(166);
/**
 * Created by wangzhw on 2017/5/09.
 */
...
var $ = window.$;
var shopId = __WEBPACK_IMPORTED_MODULE_1__common_js_home__["a" /* default */].getUrlParams('shopId');
var $containerImg = $('#contacts-topImg');
 ...
 * contacts背景图
 */
__WEBPACK_IMPORTED_MODULE_1__common_js_home__["a" /* default */].getAdvert({ shopId: shopId, position: 'CONTACTS' }).then(function (res) {
  if (res.data && !res.data.code) {
    if (res.data.data !== null && res.data.data.length !== 0) {
      ...
      var img = '<img src="/images/defaultPro.png", alt="" class="default-product">';
      $containerImg.append(img);
    }
  }
});
...
function validateSend() {
  ...
  // }
  if (phone === '') {
    return __WEBPACK_IMPORTED_MODULE_0__common_js_verification__["a" /* default */].checkEmail(email) && company.length > 0 && msg.length > 0;
  } else {
    return __WEBPACK_IMPORTED_MODULE_0__common_js_verification__["a" /* default */].checkEmail(email) && phone.length > 0 && company.length > 0 && msg.length > 0;
  }
}
...
$validateInput.on('keyup', function (e) {
  ...
  switch (name) {
    ...
    case 'email':
      ...
      break;
    case 'phone':
      var ifPhone = __WEBPACK_IMPORTED_MODULE_0__common_js_verification__["a" /* default */].checkPhone(inputValue);
