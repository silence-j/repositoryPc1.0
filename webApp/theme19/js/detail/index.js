...
import detail from '../../../common/js/detail/index.js'
...
//         attrdesc += `<li><label title="${item.propertyNameEn}">${item.propertyNameEn}</label><em>:</em> <span title="${item.propertyValueNameEn}">${item.propertyValueNameEn}</span></li>`
//       })
//     }
...
//       if (!lbl || !spn) return
//       attrdesc += `<li><label title="${lbl}">${lbl}</label><em>:</em> <span title="${spn}">${spn}</span></li>`
//     })
...
//     })
//     // mainEl.find('.spec-select').on('click', '.select3-options>li', (e) => {
//     //   console.log(99)
//     //   alert(992)
//     //   e.preventDefault()
//     //   // 规格对应的库存
...
//     //   let flag = false
//     //   for (let i = 0, len = allselect.length; i < len; i++) {
//     //     if (!allselect.eq(i).find('li.selected').attr('rel')) {
//     //       flag = true
//     //       break
//     //     }
//     //     let lbl = allselect.eq(i).parents('.select3').prev('label').attr('data-val')
//     //     specgroup += lbl + ':' + allselect.eq(i).find('li.selected').attr('rel') + ';'
//     //   }
//     //   detail.skuPriceShow(false, specgroup)
//     // })
...
//     let tit = `<li class="tit"><p>Price(${detail.skuSpec[specName].priceUnit})</p><p>Quantity</p></li>`
