...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__user_userApi__ = __webpack_require__(58);
 ...
 */
var url = location.protocol + '//' + window.location.host + '/users/facebookBack/'; // + shopId
__WEBPACK_IMPORTED_MODULE_0__user_userApi__["a" /* default */].facebookOuth(url).then(function (res) {
  if (res.data.code === 0) {
    if (plat === 1) {
